...
void ADC0_InitSWTriggerSeq3_Ch9(void){ 
  ...
  ADC0_ACTSS_R |= 0x0008;         // 14) enable sample sequencer 3
	ADC0_SAC_R &= ~0x07;            // 15) Disable oversampling
	//ADC0_SAC_R |= 0x02;             // 15) Enable  4x oversampling
	//ADC0_SAC_R |= 0x04;             // 15) Enable 16x oversampling
	//ADC0_SAC_R |= 0x06;             // 15) Enable 64x oversampling
}
